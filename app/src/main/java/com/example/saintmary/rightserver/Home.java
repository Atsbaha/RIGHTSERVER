...
import com.example.saintmary.rightserver.ViewHolder.MenuViewHolder;
...
//    MaterialEditText edtName;
    ...
    Category newCategory;//this helps the admin to add new category to database
    //i think this is url
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        categories = database.getReference("Category");//netsa
...
//            final StorageReference imageFolder =storageReference.child("Category").child(imageName);//here we cancelled the keyword "new"
                         ...
                         public void onSuccess(UploadTask.TaskSnapshot taskSnapshot)
                         {
                             ...
                             imageFolder.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>(){
                                 ...
                                 public void onSuccess(Uri saveUri)
                                 {
                                     ...
                                     newCategory=new Category(edtName.getText().toString(),saveUri.toString());
                                 }
                             });
                         }
                     })
        ...
        {
            Toast.makeText(Home.this, "please select Image", Toast.LENGTH_SHORT).show();
        }
    ...
    private void loadMenu() {
        adapter=new FirebaseRecyclerAdapter<Category, MenuViewHolder>(
            ...
            protected void populateViewHolder(MenuViewHolder viewHolder, Category model, int position) {
                ...
                Picasso.with(Home.this).load(model.getImage())//getBaseContext() in Home.this
...
//            Paper.book().destroy();
        ...
        else if(id==R.id.btnEnableUser)
        {
            /*Intent intent=new Intent(Home.this,EUser.class);
                        ...
                        user.child(Common.wawEnable.getPhone())
                                ...
                                .addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        ...
                                        Toast.makeText(Home.this,"User Is Enabled",Toast.LENGTH_SHORT).show();
                                    }
                                })
                                .addOnFailureListener(new OnFailureListener() {
                                    @Override
...
//                    }
                    ...
                    Toast.makeText(Home.this,"User in not registered",Toast.LENGTH_SHORT).show();
                }
...
//                 item.setName(btnUpload.getText().toString());
        ...
        //to update the image
    private void changeMusic(final Category item) {
        if(saveUri!=null)
        {
            final ProgressDialog mDialog=new ProgressDialog(this);
            mDialog.setMessage("Uploading");
